...
Captured At: 2026-08-27T00:35:52+08:00
...
| vllm-ascend | `repos/vllm-ascend-blockwise-dsa-reimplementation` | `feature/blockwise-dsa-mooncake-v1-reimplementation` | `db43a232d8ba0fb511983cd75ca04e6c12408bc9` | false | lock source; restores to `repos/vllm-ascend` |
...
- The replacement plus ticket 18 range `0d6dd0d26..db43a232d` is signed off and published to GitCode branch `feature/blockwise-dsa-mooncake-v1-reimplementation`.
- `git ls-remote origin refs/heads/feature/blockwise-dsa-mooncake-v1-reimplementation` was verified for the ticket 18 publication and returned exactly `db43a232d8ba0fb511983cd75ca04e6c12408bc9`.
