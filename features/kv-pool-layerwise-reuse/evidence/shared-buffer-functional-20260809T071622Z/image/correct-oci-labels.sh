...
readonly source_manifest=sha256:0cac821008e646ad953a5fa1e6b625e5b9b7a2bf3df14045f1098d76cee21483
readonly source_config=sha256:26691aea3c4d44a2409f87b35797df4b76ff166e47a1955eb696187170c0fef4
readonly import_base=docker.io/library/vllm-ascend/kv-pool-layerwise-label-fix-535555917

oci_tmp=$(mktemp -d /tmp/kvpool-oci-labels-535555917-XXXXXX)
case ${oci_tmp} in
  /tmp/kvpool-oci-labels-535555917-*) ;;
