...
readonly expected_image=${EXPECTED_IMAGE:-docker.io/library/vllm-ascend:kv-pool-layerwise-main-54503ece-a2-1829639a-df3f74ed-20260808T111904Z}
readonly expected_config=${EXPECTED_CONFIG:-sha256:2bcbaa5ea4b59874f03e8c6c6cc169edece8cac52faa5ea9f7a5313f074a3ff9}
readonly asset_dir=$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)
readonly script_dir=${OUTPUT_DIR:-${asset_dir}}
readonly remote_root=${REMOTE_ROOT:-/tmp/shared-buffer-functional-20260808T111904Z}
