...
datasets = [dict(
    type=CustomDataset,
    abbr='reuse3',
    path='/client-tools/runs/dp1-16384-reuse3-o1-c8/warmup/7ecc4846090ca7f9/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-reuse3-o1-c8/warmup/7ecc4846090ca7f9/aisbench-output'
