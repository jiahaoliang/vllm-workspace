...
datasets = [dict(
    type=CustomDataset,
    abbr='reuse3',
    path='/client-tools/runs/dp1-16384-reuse3-o1-c8/formal-1/4d034747b2da176b/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-reuse3-o1-c8/formal-1/4d034747b2da176b/aisbench-output'
