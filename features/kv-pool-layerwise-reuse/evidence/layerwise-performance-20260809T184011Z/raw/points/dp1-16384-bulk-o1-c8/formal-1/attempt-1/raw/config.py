...
datasets = [dict(
    type=CustomDataset,
    abbr='bulk',
    path='/client-tools/runs/dp1-16384-bulk-o1-c8/formal-1/c079ae0b069d19a7/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-bulk-o1-c8/formal-1/c079ae0b069d19a7/aisbench-output'
