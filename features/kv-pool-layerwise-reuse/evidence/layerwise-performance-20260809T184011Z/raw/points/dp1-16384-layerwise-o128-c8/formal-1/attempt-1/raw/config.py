...
datasets = [dict(
    type=CustomDataset,
    abbr='layerwise',
    path='/client-tools/runs/dp1-16384-layerwise-o128-c8/formal-1/e3431a34afa628e9/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-layerwise-o128-c8/formal-1/e3431a34afa628e9/aisbench-output'
