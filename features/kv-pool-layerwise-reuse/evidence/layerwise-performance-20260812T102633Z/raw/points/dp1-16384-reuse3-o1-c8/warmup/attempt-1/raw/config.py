...
datasets = [dict(
    type=CustomDataset,
    abbr='reuse3',
    path='/client-tools/runs/dp1-16384-reuse3-o1-c8/warmup/538fb78e8f488dbf/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-reuse3-o1-c8/warmup/538fb78e8f488dbf/aisbench-output'
