...
readonly expected_image=${EXPECTED_IMAGE:-docker.io/library/vllm-ascend:kv-pool-layerwise-main-54503ece-a2-2d179d07-df3f74ed-20260808T085132Z}
readonly expected_config=${EXPECTED_CONFIG:-sha256:b073f5891dcb131d9c9082e375acb3b192220ec7b4d6a1e2ab958a8b95a6737a}
readonly asset_dir=$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)
readonly script_dir=${OUTPUT_DIR:-${asset_dir}}
readonly remote_root=${REMOTE_ROOT:-/tmp/shared-buffer-functional-20260808T090506Z}
