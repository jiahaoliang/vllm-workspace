...
datasets = [dict(
    type=CustomDataset,
    abbr='reuse3',
    path='/client-tools/runs/dp1-16384-reuse3-o1-c8/formal-1/b75ad787925db085/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-reuse3-o1-c8/formal-1/b75ad787925db085/aisbench-output'
