...
datasets = [dict(
    type=CustomDataset,
    abbr='reuse3',
    path='/client-tools/runs/dp1-16384-reuse3-o1-c8/warmup/7e052482a42581fd/dataset.jsonl',
...
work_dir='/client-tools/runs/dp1-16384-reuse3-o1-c8/warmup/7e052482a42581fd/aisbench-output'
