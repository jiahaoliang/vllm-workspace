...
readonly expected_image=${EXPECTED_IMAGE:-docker.io/library/vllm-ascend:kv-pool-layerwise-main-54503ece-a2-d74269a0-df3f74ed-20260808T203742Z}
readonly expected_config=${EXPECTED_CONFIG:-sha256:7277450f383361eae3481c09be913522e0fa62a11d9c78eaf753a5542f4783eb}
readonly asset_dir=$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)
readonly script_dir=${OUTPUT_DIR:-${asset_dir}}
readonly remote_root=${REMOTE_ROOT:-/tmp/shared-buffer-functional-20260808T203742Z}
