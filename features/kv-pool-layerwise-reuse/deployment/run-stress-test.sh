...
readonly image=docker.io/library/vllm-ascend:kv-pool-layerwise-main-54503ece-a2-14beaf16-20260731T064607Z-r1
...
identity_check() {
  ...
  test "$(git -C repos/vllm-ascend rev-parse HEAD)" = d5f0ea7f8c238009b03bc3d5eeeb19a71d80b873
...
for revision in 54503ecec0f3ac31e5ecfc5f28652e4cc42307b5 d5f0ea7f8c238009b03bc3d5eeeb19a71d80b873 786c77ff7692bed58dd99971afef87d6b690cbe3; do
...
{
  git -C "${workspace_root}/repos/vllm-ascend" diff --name-only --diff-filter=ACMRT 14beaf161cca6f1e044e20529ca96c6554dbbe50 -- vllm_ascend
