...
| Derived image | `docker.io/library/vllm-ascend:kv-pool-layerwise-main-54503ece-a2-2770cd3a-df3f74ed-20260808T042014Z` |
| Derived manifest | `PENDING` |
| Derived config | `PENDING` |
| Creation | Single Python-file patch followed by `nerdctl commit`; not a native rebuild |
...
| Derived image identity/probe | PENDING | |
| Derived-image CPU/mock | PENDING | |
